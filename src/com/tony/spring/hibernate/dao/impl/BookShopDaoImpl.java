package com.tony.spring.hibernate.dao.impl;
...
import com.tony.spring.hibernate.exception.BookStockException;
import com.tony.spring.hibernate.exception.UserAccountException;
...
public class BookShopDaoImpl implements BookShopDao {
	...
	//Not advice that use "HibernateTemplate" or "HibernateDaoSupport"
	//Because it will be coupling the API of "Dao" and "Spring"
	//private HibernateTemplate hibernateTemplate;
	
	
	//Get the session that is binding with current thread
